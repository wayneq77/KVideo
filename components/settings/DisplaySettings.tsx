...
export function DisplaySettings({
    ...
    return (
        <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-[var(--radius-2xl)] shadow-[var(--shadow-sm)] p-6 mb-6">
            <h2 className="text-xl font-semibold text-[var(--text-color)] mb-4">顯示設置</h2>

            {/* Remember Scroll Position Toggle */}
            <div className="mb-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="font-medium text-[var(--text-color)]">記住滾動位置</h3>
                        <p className="text-sm text-[var(--text-color-secondary)] mt-1">
                            退出或刷新頁面後，自動恢復到之前的滾動位置
                        </p>
                    </div>
                    <Switch
            ...
            {/* Search Display Mode */}
            <div>
                <h3 className="font-medium text-[var(--text-color)] mb-2">搜索結果顯示方式</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    >
                        ...
                        <div className="text-sm opacity-80 mt-1">相同名稱的視頻合併爲一個卡片</div>
                    </button>
                </div>
            </div>
        </div>
